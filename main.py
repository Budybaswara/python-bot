...
BOT_TOKEN = "7214981691:AAF61UDMR8alYK0AB3I2Hao6wd4KsD1nyRQ"
PAYMENT_CHANNEL = "@Torgaspump" #add payment channel here including the '@' sign
OWNER_ID = 1753361927 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@Torgaspump"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
